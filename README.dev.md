...
git clone git@github.com:edwardchalstrey1/baklava .
...
Don't forget to also make a [release on GitHub](https://github.com/edwardchalstrey1/baklava/releases/new).GitHub-Zenodo integration will also trigger Zenodo into making a snapshot of your repository and sticking a DOI on it.